    ...
    describe('password encryption', function() {
        ...
        describe('on creation', function() {
            ...
            var createUser = function() {
                return User.create({ email: 'obama@gmail.com', password: 'potus', firstName: 'Barack', lastName: 'Obama' });
            };
        ...
        describe('purchases method', function() {

            var createUser = function() {
                return User.create({ email: 'obama@gmail.com', password: 'potus', firstName: 'Barack', lastName: 'Obama' });
            };

            it('should get purchases associated with a user', function() {
                createUser().then(function(user) {
                   return Purchase.create(user)
                   .then(function() {
                        expect(user.getPurchases()).to.have.length(1);
                   });
                });
            });
        });
